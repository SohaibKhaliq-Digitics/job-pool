                    ...
                    <div class="row content-justify-between">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <ul class="social text-center text-md-right text-lg-right">
                                <li>
                                    <a href="https://www.facebook.com/GIMS.UAAR" target="_blank" class="Facebook">
                                        <i class="ion-social-facebook"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="http://wwww.twitter.com/themefisher" target="_blank" class="Twitter">
                                ...
                                <li>
                                    <a href="http://wwww.fb.com/themefisher" target="_blank" class="Google Plus">
