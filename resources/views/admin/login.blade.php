...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{ url('em/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{ url('em/index2.html') }}" class="h1"><b>Event </b>Manager</a>
    </div>
    <div class="card-body">
      ...
      <form action="{{ url ('em/loginPost')}}" method="post"> @csrf
...
<!-- AdminLTE App -->
<script src="{{ url('em//js/adminlte.min.js') }}"></script>
</body>
</html>
